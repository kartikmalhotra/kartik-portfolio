...
export const info = {
  ...
  socials: [
    ...
    {
      link: 'https://drive.google.com/file/d/1cbYwSH7e2L4vHp7H2ArUl5HfDUjogmr_/view?usp=sharing', // this should be https://yourname.com/resume.pdf once you've deployed
